...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $query_pengajuan)) {
        ...
        $query_detail = "INSERT INTO detail_surat (id_pengajuan, nama_lengkap, tempat_lahir, tanggal_lahir, nik, alamat, agama, pekerjaan, keperluan, jenis_usaha, file_pendukung) 
                         VALUES ('$id_pengajuan', '$nama_lengkap', '$tempat_lahir', '$tanggal_lahir', '$nik', '$alamat', '$agama', '$pekerjaan', '$keperluan', '$jenis_usaha', '$target_file')";

        if (mysqli_query($conn, $query_detail)) {
            echo json_encode(["status" => "success", "message" => "Pengajuan surat Usaha berhasil!"]);
        } else {
