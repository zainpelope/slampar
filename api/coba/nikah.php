...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $query_pengajuan)) {
        ...
        echo "<script>alert('Pengajuan surat Belum Menikah berhasil!'); window.location.href='../coba/coba.php';</script>";
    } else {
...
<head>
    <title>Form Pengajuan Surat Belum Menikah</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>

<body>
    <div class="container mt-5">
        <h2>Form Pengajuan Surat Belum Menikah</h2>
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="status_pernikahan" class="form-control" required></textarea>
            </div>
            <div class="mb-3">
