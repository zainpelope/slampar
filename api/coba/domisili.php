...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $query_pengajuan)) {
        ...
        echo "<script>alert('Pengajuan surat domisili berhasil!'); window.location.href='../coba/coba.php';</script>";
    } else {
...
<head>
    <title>Form Pengajuan Surat Domisili</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>

<body>
    <div class="container mt-5">
        <h2>Form Pengajuan Surat Domisili</h2>
