            ...
            <div class="container">
                <div class="header">
                    ...
                    <div class="header-text">
                        ...
                        <hp>Alamat : Jl. Raya Larangan Slampar, Pamekasan - Telp: 081703709509</p>
                    </div>
                </div>
                <hr>
                <h3 style="text-align: center; text-decoration: underline; margin-bottom: 10px;">SURAT KETERANGAN DOMISILI</h3>
                <p style="text-align: center; margin-bottom: 30px;">Nomor: 571/92/434.501.16/<?= date('Y'); ?></p>
