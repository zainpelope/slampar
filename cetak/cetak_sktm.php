...
?>
        ...
        <body>
            <div class="container">
                ...
                <hr>
                <h3 style="text-align: center; text-decoration: underline; margin-bottom: 10px;">SURAT KETERANGAN TIDAK MAMPU</h3>
                <p style="text-align: center; margin-bottom: 30px;">Nomor: 475/93/432.504.16/<?= date('Y'); ?></p>
                ...
                <div class="isi">
                    ...
                    <p>Orang tersebut betul-betul Penduduk Desa Larangan Slampar dan keadaan ekonominya lemah (TIDAK MAMPU).</p>
